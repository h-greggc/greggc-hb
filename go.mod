module github.com/h-greggc/greggc-hb

go 1.22

require (
	github.com/HugoBlox/hugo-blox-builder/modules/blox-plugin-decap-cms v0.1.2-0.20250301201144-44e75541f7be
...
require (
	github.com/HugoBlox/all-access/blox-all-access v0.0.0-20241105012909-6426bf8a9975
